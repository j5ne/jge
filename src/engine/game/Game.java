...
public class Game {
    ...
    public void init() {
        ...
        // Create the window
        window = glfwCreateWindow(width, height, "JGE Project", NULL, NULL);
        if ( window == NULL )
    ...
    public void loop() {
        ...
        while ( !glfwWindowShouldClose(window) ) {
            ...
            for(Node node : getRoot().getDescendants()) {
                for (var entry : node.getComponents().entrySet()) {
                    entry.getValue().draw();
                }
            }
